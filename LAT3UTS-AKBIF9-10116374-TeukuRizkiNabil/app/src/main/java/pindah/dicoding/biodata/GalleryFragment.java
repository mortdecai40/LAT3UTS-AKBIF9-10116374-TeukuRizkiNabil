...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lstgallery.add(new gallery("Rizki Nabil",R.drawable.photo1));
        lstgallery.add(new gallery("Rizki Nabil",R.drawable.photo2));
        lstgallery.add(new gallery("Rizki Nabil",R.drawable.photo3));
        lstgallery.add(new gallery("Rizki Nabil",R.drawable.photo4));
